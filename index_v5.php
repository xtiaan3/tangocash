<?php
/**
 * TangoCash homepage — V5 preview (wandr.studio, the real one).
 *
 * Distinct from v2/v3:
...
$signed_in  = false;
include __DIR__ . '/_header_v5.php';
?>

<!-- ==========================================================================
     Hero
     ========================================================================== -->
<section class="tc_v5_hero">
    <div class="tc_v5_hero_eyebrow">
        <span class="tc_v5_hero_eyebrow_star">✱</span>
        <span>Reference fintech for BrainLock</span>
    </div>

    <h1 class="tc_v5_display tc_v5_display_solid">From passwords and PIN resets to</h1>
    <h1 class="tc_v5_display tc_v5_display_mute">payments that just work.</h1>

    <p class="tc_v5_hero_sub">
    ...
    <div class="tc_v5_hero_cta_wrap">
        <a class="tc_v5_cta_white" href="/auth/start.php">
            <span>Open the demo</span>
            <span class="tc_v5_cta_white_star">✱</span>
        </a>
    </div>
</section>
...
<!-- ==========================================================================
     Marquee
     ========================================================================== -->
<div class="tc_v5_marquee" aria-hidden="true">
    <div class="tc_v5_marquee_track">
        <?php for ($i = 0; $i < 6; $i++): ?>
            <span class="tc_v5_marquee_word">Driven by simplicity</span>
            <span class="tc_v5_marquee_star">✱</span>
            <span class="tc_v5_marquee_word">Send. Receive. Done.</span>
            <span class="tc_v5_marquee_star">✱</span>
        <?php endfor; ?>
    </div>
</div>
...
<!-- ==========================================================================
     ...
     ========================================================================== -->
<section class="tc_v5_slab" id="v5-what">
    <div class="tc_v5_slab_inner">
        <div class="tc_v5_slab_kicker">
            <span class="tc_v5_slab_kicker_star">✱</span>
            <span>How TangoCash works &mdash; the four pieces</span>
        </div>

        <!-- 01 — What it is -->
        <div class="tc_v5_panel">
            <div class="tc_v5_panel_num">(01)</div>
            <h2 class="tc_v5_panel_title">P2P<br>WALLET</h2>
            <div class="tc_v5_panel_text">
                <p class="tc_v5_panel_body">
        ...
        <div class="tc_v5_panel" id="v5-integration">
            <div class="tc_v5_panel_num">(02)</div>
            <h2 class="tc_v5_panel_title">EIGHT<br>LINES <em>OF PHP</em></h2>
            <div class="tc_v5_panel_blob" aria-hidden="true"></div>
            <div class="tc_v5_panel_text">
                <p class="tc_v5_panel_body">
        ...
        <!-- 03 — Developer Lens -->
        <div class="tc_v5_panel" id="v5-dev-lens">
            <div class="tc_v5_panel_num">(03)</div>
            <h2 class="tc_v5_panel_title">DEV<br>LENS</h2>
            <div class="tc_v5_panel_text">
                <p class="tc_v5_panel_body">
        ...
        <!-- 04 — Ship it -->
        <div class="tc_v5_panel" id="v5-try">
            <div class="tc_v5_panel_num">(04)</div>
            <h2 class="tc_v5_panel_title">SHIP<br><span class="tc_v5_panel_title_mute">YOUR OWN</span></h2>
            <div class="tc_v5_panel_text">
                <p class="tc_v5_panel_body">
...
<!-- ==========================================================================
     ...
     ========================================================================== -->
<section class="tc_v5_closer">
    <div class="tc_v5_closer_label">✱ The eight lines</div>
    <div class="tc_v5_codecard">
        <div class="tc_v5_codecard_head">
            <span class="tc_v5_codecard_dot tc_v5_codecard_dot_r"></span>
            <span class="tc_v5_codecard_dot tc_v5_codecard_dot_a"></span>
            <span class="tc_v5_codecard_dot tc_v5_codecard_dot_g"></span>
            <span class="tc_v5_codecard_file">signin.php</span>
        </div>
<pre class="tc_v5_codecard_body"><span class="c">&lt;?php</span>
...
<div class="tc_v5_marquee" aria-hidden="true">
    <div class="tc_v5_marquee_track">
        <?php for ($i = 0; $i < 6; $i++): ?>
            <span class="tc_v5_marquee_word">No passwords. No resets.</span>
            <span class="tc_v5_marquee_star">✱</span>
            <span class="tc_v5_marquee_word">Just sign in.</span>
            <span class="tc_v5_marquee_star">✱</span>
        <?php endfor; ?>
    </div>
</div>
...
<!-- ==========================================================================
     ...
     ========================================================================== -->
<section class="tc_v5_closer">
    <h2 class="tc_v5_display tc_v5_display_solid">Try the demo.</h2>
    <h2 class="tc_v5_display tc_v5_display_neon">Ship your own.</h2>
    <div class="tc_v5_hero_cta_wrap">
        <a class="tc_v5_cta_white" href="/auth/start.php">
...
<!-- ==========================================================================
     Footer
     ========================================================================== -->
<footer class="tc_v5_footer">
    <div class="tc_v5_footer_inner">
        <div>
